...
<dl>
  ...
  <dd>The structural design of shared information environments. It involves the organization, labelling, and navigation schemes within information systems.</dd>
  <dt>Design Tokens</dt>
  <dd>Named entities that store visual design attributes—colors, spacing, typography—so they can be maintained in a single source of truth.</dd>
</dl>
